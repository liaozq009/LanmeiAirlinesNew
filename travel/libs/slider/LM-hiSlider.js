    ...
    Slider.prototype = {
        ...
        setLayout: function(){
            ...
            if(this.options.isShowControls){
                this.$prev = $('<a href="javascript:;" class="hiSlider-btn-prev"><img src="'+this.options.prevImg+'"></a>');
                this.$next = $('<a href="javascript:;" class="hiSlider-btn-next"><img src="'+this.options.nextImg+'"></a>');
        ...
        autoPlay: function(){
            ...
            this.$container.children('li').mouseover(function(event) {
               clearTimeout(self.playTimer);
