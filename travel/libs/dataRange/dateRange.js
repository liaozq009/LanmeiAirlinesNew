    ...
    var defaults = {
        ...
        minValidDate : '1505643457', //最小可用时间，控制日期选择器的可选力度
        maxValidDate : '1605643457', // 最大可用时间，与stopToday 配置互斥
...
pickerDateRange.prototype.show = function(isCompare, __method) {
	...
	$("#" + this.calendarId).css('top', pos.top + (__method.mOpts.theme=='ta'?50:22) + 'px');
	//第一次显示的时候，一定要初始化输入框
