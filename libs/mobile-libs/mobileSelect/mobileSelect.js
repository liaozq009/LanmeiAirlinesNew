 ...
 */
 ...
 window.MobileSelect = (function() {
	...
	function MobileSelect(config) {
		...
		this.tip1Text = config.tip1 ? config.tip1 : '';
		this.tip2Text = config.tip2 ? config.tip2 : '';
		this.cancelText = config.cancel ? config.cancel : 'Cancel';
		this.okText = config.ok ? config.ok : 'OK';
		this.jsonType =  false;
		this.jsonData = [];
		this.checkDataType();
		this.renderWheels(this.wheelsData,this.tip1Text,this.tip2Text,this.cancelText,this.okText);
		this.displayJson = []; 
		this.cascade = false;
		this.startY;
		this.moveEndY;
	...
	MobileSelect.prototype = {
		...
		renderWheels: function(wheelsData,tip1Text,tip2Text,cancelText,okText){
			var _this = this;
			...
			'<div class="wheels">'+
			'</div>'+
			'<div class="selectLine"><p class="adult">'+tip1Text+'</p><p class="child">'+tip2Text+'</p></div>'+
