var lmMenuCom = {
	...
	otherEvent:function(){
		...
		$('.a-search-flight').click(function(event) {
			...
			window.open('http://b2c.lanmeiairlines.com/lqWeb/reservation/AVQuery.do?orgcity=CAN&dstcity=PNH&language=CN&CURRENCY=USD&tripType=OW&takeoffDate='+startTime+'&cabinType=ECONOMY&adultCount=1&childCount=0&returnDate=');
		});
	},
